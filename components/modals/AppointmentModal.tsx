    ...
    <>
      ...
      >
        <div className="relative">
          {/* Description */}
          <p className="text-sm text-[#191a15]/50 mb-5 leading-relaxed pr-0 md:pr-24">
          ...
          {/* Psychologist's photo - right (absolute positioning on desktop) */}
          <div className="hidden md:block absolute top-0 right-0">
            <Image
              src={psychologist.avatar_url}
              alt={psychologist.name}
              fill
              className="w-[96px] h-[96px] rounded-xl object-cover"
            />
          </div>
          ...
          <div className="flex items-center gap-3 mb-10">
            ...
            <Image
              ...
              alt={psychologist.name}
              fill
              className="w-11 h-11 rounded-xl object-cover md:hidden"
            />
            ...
            <div className="flex flex-col">
              <textarea
                ...
                className={`
                  ...
                  border rounded-xl transition-colors resize-none
